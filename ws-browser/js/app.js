...
var wsbrowser = angular.module('ws-browser', 
    ['lp-directives', 'card-directives',
     'trees-directives', 'fav-directives',
     'ws-directives', 'ui.router', 'kbaseLogin', 'FeedLoad', 'ui.bootstrap'])
...
wsbrowser.run(function ($rootScope, $state, $stateParams, $location) {
